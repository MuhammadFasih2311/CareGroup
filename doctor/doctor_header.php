...
<title>CARE Group - Doctor Panel</title>
...
<nav class="admin-navbar px-4 d-flex justify-content-between align-items-center">
    ...
    <div class="d-flex align-items-center">
        ...
        <h4 class="brand fw-bold text-white m-0 d-none d-lg-block brand-hover"  data-aos="fade-right">
            Doctor <span class="text-warning">Panel</span>
        </h4>
    ...
    <div class="d-flex align-items-center gap-3"  data-aos="fade-left">
        ...
        <div class="welcome-text text-white d-none d-sm-block">
            <span>Welcome,</span>
            <strong class="text-warning"><?= $doctor['name']; ?></strong>
        </div>

        <div class="dropdown">
            <button class="btn admin-profile-btn d-flex align-items-center gap-2" data-bs-toggle="dropdown">

                <div class="avatar-wrapper avatar-hover">
                    <img src="../<?= $doctor['image'] ?>" class="admin-avatar">
                </div>
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-lg admin-dropdown">
                <li><a class="dropdown-item" href="doctor_profile.php"><i class="bi bi-person-circle me-2"></i> Profile</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item logout-drop" href="../logout.php"><i class="bi bi-box-arrow-right me-2"></i> Logout</a></li>
            </ul>
